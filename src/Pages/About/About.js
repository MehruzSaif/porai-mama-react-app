            ...
            <Card className='my-5 about-card'>
                ...
                <Card.Body>
                    ...
                    <Card.Text className='about-text'>
                        A quick and keen but <span className='fakibaj'>ফাঁকিবাজ</span> learner who wants to improve skills as a Full-Stack Web Developer. Highly organized, responsible, outgoing, technology savvy with ideas, adaptable in any scenario, and demonstrated capacity to improve oneself and others. <br /><br />
